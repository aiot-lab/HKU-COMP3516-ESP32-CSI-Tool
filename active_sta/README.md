...
<p align="center"><img src="doc/fig/vscode_extensions.jpg" width=50% height=""></p>
...
<p align="center"><img src="doc/fig/homepage_IDF_install.jpg" width=50% height=""></p>

2. Click `Advanced`
3. For ESP-IDF version, **choose `v4.4.4 (release version)`**; Leave other settings with default value.
<p align="center"><img src="doc/fig/tool_setup.jpg" width=50% height=""></p>

4. Continue. Download tools.
<p align="center"><img src="doc/fig/tool_download.jpg" width=50% height=""></p>

5. Compelte downloading. If there shows additional requirement for USB configuration, just do it.
<p align="center"><img src="doc/fig/tool_end.jpg" width=50% height=""></p>
...
![](doc/fig/enable_CSI.jpg)
![](doc/fig/enable_CSI_collecting_to_serial.jpg)
1. Build, Compile and Flash! A monitor will show up if all work fine.
![](doc/fig/tool_bar_start.jpg)
![](doc/fig/build.jpg)
![](doc/fig/flash.jpg)
![](doc/fig/monitor.jpg)
